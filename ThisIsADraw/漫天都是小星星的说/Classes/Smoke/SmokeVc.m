...
//  漫天都是小星星的说
//
//  Created by 飞奔的羊 on 16/9/1.
//  Copyright © 2016年 itcast. All rights reserved.
//

#import "SmokeVc.h"

@implementation SmokeVc
@synthesize dazLayer;
...
- (void)viewDidLoad
{
	...
	self.dazLayer.seed = (arc4random()%100)+102;//用于初始化随机数产生的种子
	
	// Create the rocket
	CAEmitterCell* rocket = [CAEmitterCell emitterCell];
	
	rocket.birthRate		= 5.0;//粒子产生系数，默认1.0
	...
	burst.birthRate			= 2.0;		// at the end of travel//粒子产生系数，默认为1.0
	burst.velocity			= 0;    //速度
