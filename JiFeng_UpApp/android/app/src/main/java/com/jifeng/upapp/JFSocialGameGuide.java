...
final class JFSocialGameGuide {
    static final String MOOD_ICEBREAKER = "轻松破冰";
    static final String MOOD_FRIENDS = "熟人聊天";
    static final String MOOD_LIVELY = "热闹互动";
    static final String MOOD_THINKING = "推理动脑";
    ...
    private JFSocialGameGuide(String id, String title, String subtitle,
                              int minPlayers, int maxPlayers, int durationMinutes,
                              String mood, String props, String summary, String setup,
                              String[] steps, String[] tips, String launchKind) {
        this.id = id;
        this.title = title;
    ...
    boolean playableInApp() {
        return launchKind != null;
    }

    private static JFSocialGameGuide guide(String id, String title, String subtitle,
                                            int minPlayers, int maxPlayers, int durationMinutes,
                                            String mood, String props, String summary, String setup,
                                            String[] steps, String[] tips, String launchKind) {
        return new JFSocialGameGuide(id, title, subtitle, minPlayers, maxPlayers, durationMinutes,
            mood, props, summary, setup, steps, tips, launchKind);
    }

    static List<JFSocialGameGuide> all() {
        return GUIDES;
    }

    private static final List<JFSocialGameGuide> GUIDES = Collections.unmodifiableList(Arrays.asList(
        guide("never_have_i_ever", "我有你没有", "谁没有，谁熄灭一根", 2, 10, 20,
            MOOD_FRIENDS, "每人一部手机",
        ...
        guide("undercover", "谁是卧底", "相近词语里的隐藏身份", 4, 12, 30,
            MOOD_THINKING, "手机发词",
        ...
        guide("king", "国王游戏", "抽到国王的人发布双人指令", 4, 12, 25,
            MOOD_LIVELY, "手机发牌",
        ...
        guide("truth_or_dare", "真心话大冒险", "回答问题或完成挑战", 3, 10, 25,
            MOOD_FRIENDS, "无需道具",
        ...
        guide("liars_dice", "吹牛骰子", "报价、质疑与概率判断", 3, 10, 25,
            MOOD_LIVELY, "每人若干骰子",
        ...
        guide("party_cards", "小姐牌与派对牌", "一副牌驱动整场任务", 3, 12, 35,
            MOOD_LIVELY, "手机牌堆",
        ...
        guide("gesture_bomb", "手势炸弹", "看清手势再快速模仿", 3, 12, 12,
            MOOD_ICEBREAKER, "一台手机",
        ...
        guide("turtle_soup", "海龟汤", "只靠是、否还原离奇故事", 3, 12, 40,
            MOOD_THINKING, "一则谜面与答案",
        ...
        guide("three_gardens", "逛三园", "同类词接龙，重复就出错", 4, 15, 15,
            MOOD_LIVELY, "无需道具",
        ...
        guide("who_am_i", "我是谁", "用提问猜出额头上的身份", 4, 12, 25,
            MOOD_ICEBREAKER, "身份词卡",
        ...
        guide("telephone", "动作传声筒", "一段表演会被传成什么样", 6, 20, 20,
            MOOD_LIVELY, "题目卡或短句",
        ...
        guide("count_seven", "逢七过", "数字里有 7 就用动作代替", 3, 15, 12,
            MOOD_ICEBREAKER, "无需道具",
        ...
        guide("story_chain", "关键词故事接龙", "每人一句，把随机词串成故事", 3, 10, 20,
            MOOD_ICEBREAKER, "若干关键词",
        ...
        guide("most_likely", "谁最像", "同时指向最符合描述的人", 4, 12, 18,
            MOOD_FRIENDS, "问题题库",
